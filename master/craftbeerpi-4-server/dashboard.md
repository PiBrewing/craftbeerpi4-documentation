...
| Actor               | Adds an Actor                                                                                                                              | <p><b>Name:</b> specifies a name for the Actor(displayed).</p><p><b>Actor:</b> Select an Actor.</p><p><b>Size:</b> Text Size of displayed Actt</p><p><b>Color:</b> Displayed color of item</p><p><b>Digits:</b> Digits to be shown for data</p><p><b>Action:</b> Displays action button if Actor comes with actions (e.g. Power settings).</p>                                                             |
