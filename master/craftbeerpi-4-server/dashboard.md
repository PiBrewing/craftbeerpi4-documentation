...
| Chart               | <p>Adds a chart to display sensor values</p><p>Please se also [here](datalogging.md)</p>                                                                                                      | <p>Name: specifies a name for the Chart (displayed).</p><p>Sensor: select sensor data to be displayed.</p><p>Linecolor: define the color of the data.</p><p>Refresh: Refresh rate for the chart in seconds.</p><p>Width/Height: Defines chart size.</p>                                                                                                          |
| GrafanaChart               | Adds a Grafana based chart to display sensor values                                                                                                      | <p>Name: specifies a name for the Chart.</p><p>url: enter url from your grafana dashboard (details [here](datalogging.md#grafana-dashboard-chart)).</p><p>panelID: Enter the panelID from the URL</p><p>Refresh: Refresh rate for the chart (e.g. 10s for 10 seconds).</p><p>Timeframe: defines the displayed timeframe for the chart (e.g. now-7d for the past 7 days until now)</p><p>Width/Height: Defines chart size.</p>                                                                                                          |
