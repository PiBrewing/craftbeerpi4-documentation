...
| Liquid              | <p>Name: specifies a name for the Item (not displayed).</p><p>Sensor: select sensor to be linked to liquid level.</p><p>Color: define liquid overlay color.</p><p>maxvalue: define 100% value for liquid level.</p><p>Width/Height: Defines chart size.                                                                                                                             | To be described                                                                                                                                                                                                                                                                                                                                                  |
