...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kettle              | Adds a Kettle Symbol                                                                                                                       | <p><b>Name:</b> specifies a name for the Kettle (not displayed)</p><p><b>Height/Width:</b> determines the item size</p>                                                                                                                                                                                                                                                        |
| Tank                | Adds a Tank Symbol                                                                                                                         | <p><b>Name:</b> specifies a name for the Kettle (not displayed)</p><p><b>Height/Width:</b> determines the item size</p>                                                                                                                                                                                                                                                        |
| Text                | Adds text to the dashboard                                                                                                                 | <p><b>Name:</b> specifies the displayed text</p><p><b>Size:</b> defines text size</p><p><b>Color:</b> defines color of text</p>                                                                                                                                                                                                                                                       |
| TargetTemp          | Adds a target temperature input for a kettle                                                                                               | <p><b>Name:</b> specifies a name for the TargetTemp (not displayed).</p><p><b>Kettle:</b> Select Kettle for which that temp shall be displayed.</p><p><b>Unit:</b> Unit that is displayed behind target temp</p><p><b>Size:</b> Text Size of displayed target temp</p><p><b>Color:</b> Displayed color of item</p>                                                                                  |
| Sensor Data         | Adds a data field for a sensor                                                                                                             | <p><b>Name:</b> specifies a name for the sensor data (not displayed).</p><p><b>Sensor:</b> Select Sensor data to be shown.</p><p><b>Unit:</b> Unit that is displayed behind sensor data</p><p><b>Size:</b> Text Size of displayed data</p><p><b>Color:</b> Displayed color of item</p><p><b>Digits:</b> Digits to be shown for data</p><p><b>Action:</b> Displays action button if sensor comes with actions.</p> |
| Actor               | Adds an Actor                                                                                                                              | <p><b>Name:</b> specifies a name for the Actor (displayed).</p><p><b>Actor:</b> Select an Actor.</p><p><b>Size:</b> Text Size of displayed Actor</p><p><b>Color:</b> Displayed color of item</p><p><b>Digits:</b> Digits to be shown for data</p><p><b>Action:</b> Displays action button if Actor comes with actions (e.g. Power settings).</p>                                                             |
| Led                 | Adds a Led for an Actor                                                                                                                    | <p><b>Name:</b> specifies a name for the Led (not displayed).</p><p><b>Actor:</b> Defines the actor that triggers the Led state.</p><p><b>Color:</b> select the led color (green, red, blue)</p>                                                                                                                                                                                      |
| Steps               | Adds a Mashstep field (only one field possible)                                                                                            | <p><b>Name:</b> specifies a name for the MashSteps item (not displayed).</p><p><b>Width:</b> defines the item width.</p><p><b>StepSize:</b> defines the text size of the steps.</p><p><b>NameSize:</b> defines the recipe name textsize.</p>                                                                                                                                                 |
| SVG                 | You can add your custom svg items for symbols (e.g. Kettle) Details described in this [section](dashboard.md#how-to-add-custom-svg-items). | <p><b>Name:</b> specifies a name for the SVG item (not displayed).</p><p><b>Width:</b> defines the item width.</p><p><b>Widget:</b> Select a widget you copied into the widgets folder</p>                                                                                                                                                                                            |
| KettleControl       | Adds a control for your Kettle or Fermenter (FermenterHysteresis Plugin required as Kettlelogic) sd                                        | <p><b>Name:</b> specifies a name for the Kettle Control item (not displayed).</p><p><b>Kettle:</b> Select the kettle to be controlled.</p><p><b>Size:</b> Select one of three sizes for the item.</p><p><b>Orientation:</b> Select horizontal or vertical</p>                                                                                                                                |
| Clock               | Adds a clock                                                                                                                               | <p><b>Name:</b> specifies a name for the Clock item (not displayed).</p><p><b>Size:</b> Textsize of the item.</p><p><b>Showdate:</b> shows clock with date if set to yes.</p><p><b>Color:</b> defines the color of the item</p>                                                                                                                                                              |
| Chart               | <p>Adds a chart to display sensor values</p><p>Please se also [here](datalogging.md)</p>                                                                                                      | <p><b>Name:</b> specifies a name for the Chart (displayed).</p><p><b>Sensor:</b> select sensor data to be displayed.</p><p><b>Linecolor:</b> define the color of the data.</p><p><b>Refresh:</b> Refresh rate for the chart in seconds.</p><p><b>Width/Height:</b> Defines chart size.</p>                                                                                                          |
| GrafanaChart               | Adds a Grafana based chart to display sensor values                                                                                                      | <p><b>Name:</b> specifies a name for the Chart.</p><p><b>url:</b> enter url from your grafana dashboard (details [here](datalogging.md#grafana-dashboard-chart)).</p><p><b>panelID:</b> Enter the panelID from the URL</p><p><b>Refresh:</b> Refresh rate for the chart (e.g. 10s for 10 seconds).</p><p><b>Timeframe:</b> defines the displayed timeframe for the chart (e.g. now-7d for the past 7 days until now)</p><p><b>Width/Height:</b> Defines chart size.</p>                                                                                                          |
| Calculator          | Adds a volume calculator                                                                                                                   | To be described                                                                                                                                                                                                                                                                                                                                                  |
| Liquid              | Simulates the liquid level of a widget via overlay   | <p><b>Name:</b> specifies a name for the Item (not displayed).</p><p><b>Sensor:</b> select sensor to be linked to liquid level.</p><p><b>Color:</b> define liquid overlay color.</p><p><b>maxvalue:</b> define 100% value for liquid level.</p><p><b>Width/Height:</b> Defines chart size.   |
| FermenterTargetTemp | Adds a target temperature input for a Fermenter | <p><b>Name:</b> specifies a name for the TargetTemp (not displayed).</p><p><b>Fermenter:</b> Select Fermenter for which that temp shall be displayed.</p><p><b>Unit:</b> Unit that is displayed behind target temp</p><p><b>Size:</b> Text Size of displayed target temp</p><p><b>Color:</b> Displayed color of item</p>                                                                            |
| FermenterTargetPressure | Adds a target Pressure input for a Fermenter | <p><b>Name:</b> specifies a name for the TargetPressure (not displayed).</p><p><b>Fermenter:</b> Select Fermenter for which that pressure shall be displayed.</p><p><b>Unit:</b> Unit that is displayed behind target pressure</p><p><b>Size:</b> Text Size of displayed target temp</p><p><b>Color:</b> Displayed color of item</p>                                                                            |
| FermenterControl    | Adds a control for your Fermenter                                                                                                          | <p><b>Name:</b> specifies a name for the Fermenter Control item (not displayed).</p><p><b>Fermenter:</b> Select the fermenter to be controlled.</p><p><b>Size:</b> Select one of three sizes for the item.</p><p><b>Orientation:</b> Select horizontal or vertical<p>|
| FermenterSteps          | Adds a Fermenterstep field (only one field per Fermenter possible)                                                                                            | <p><b>Name:</b> specifies a name for the FermnenterSteps item (not displayed).</p><p><b>Width:</b> defines the item width.</p><p>Stepsize: defines the text size of the steps.</p><p>Namesize: defines the recipe name textsize.</p> <p><b>Fermenter:</b> specifies the femrenter for this item.</p>|
| Pipe                | Adds a pipe that displays a flow when an actor is on                                                                                       | <p><b>FlowLeft:</b> Left Flow animation if selected actor is active.</p><p><b>FlowRight:</b> Right Flow animation if selected actor is active.</p>                                                                                                                                                                                                                             |
