...
| GrafanaChart               | Adds a Grafana based chart to display sensor values                                                                                                      | <p>Name: specifies a name for the Chart.</p><p>url: enter url from your grafana dashboard (details [here](datalogging.md#grafana-dashboard-chart)).</p><p>panelID: Enter the panelID from the URL</p><p>Refresh: Refresh rate for the chart in seconds.</p><p>Width/Height: Defines chart size.</p>                                                                                                          |
