...
| Actor                   | Adds an Actor                                                                                                                              | <p>Name: specifies a name for the Actor (displayed).</p><p>Actor: Select an Actor.</p><p>Size: Text Size of displayed Actor</p><p>Color: Displayed color of item</p><p>Digits: Digits to be shown for data</p><p>Action: Displays action button if Actor comes with actions (e.g. Power settings).</p>                                                                                                                                   |
...
| Chart                   | <p>Adds a chart to display sensor values</p><p>Please se also <a href="datalogging.md">here</a></p>                                        | <p>Name: specifies a name for the Chart (displayed).</p><p>Sensor: select sensor data to be displayed.</p><p>Linecolor: define the color of the data.</p><p>Refresh: Refresh rate for the chart in seconds.</p><p>Width/Height: Defines chart size.</p>                                                                                                                                                                                  |
| GrafanaChart            | Adds a Grafana based chart to display sensor values                                                                                        | <p>Name: specifies a name for the Chart.</p><p>url: enter url from your grafana dashboard (details <a href="datalogging.md#grafana-dashboard-chart">here</a>).</p><p>panelID: Enter the panelID from the URL</p><p>Refresh: Refresh rate for the chart (e.g. 10s for 10 seconds).</p><p>Timeframe: defines the displayed timeframe for the chart (e.g. now-7d for the past 7 days until now)</p><p>Width/Height: Defines chart size.</p> |
| Calculator              | Adds a volume calculator                                                                                                                   | To be described                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Liquid                  | Simulates the liquid level of a widget via overlay                                                                                         | <p>Name: specifies a name for the Item (not displayed).</p><p>Sensor: select sensor to be linked to liquid level.</p><p>Color: define liquid overlay color.</p><p>maxvalue: define 100% value for liquid level.</p><p>Width/Height: Defines chart size.</p>                                                                                                                                                                              |
...
| FermenterTargetPressure | Adds a target Pressure input for a Fermenter                                                                                               | <p>Name: specifies a name for the TargetPressure (not displayed).</p><p>Fermenter: Select Fermenter for which that pressure shall be displayed.</p><p>Unit: Unit that is displayed behind target pressure</p><p>Size: Text Size of displayed target temp</p><p>Color: Displayed color of item</p>                                                                                                                                        |
